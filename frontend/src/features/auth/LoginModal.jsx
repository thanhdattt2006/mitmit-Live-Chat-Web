      ...
      <div className="relative w-full max-w-sm bg-[#141414] rounded-3xl shadow-2xl border border-neutral-800 flex flex-col overflow-hidden animate-slide-up text-white p-8">
        ...
        <div className="space-y-4">
          <button 
            ...
            className="w-full flex items-center justify-center gap-3 bg-white text-black py-3.5 rounded-2xl font-semibold hover:bg-gray-200 transition-colors active:scale-95 shadow-md disabled:opacity-70 disabled:cursor-wait"
          >
          ...
          <button 
            ...
            className="w-full flex items-center justify-center gap-3 bg-neutral-800 text-white py-3.5 rounded-2xl font-semibold hover:bg-neutral-700 transition-colors active:scale-95 shadow-md border border-neutral-700 mt-3 disabled:opacity-70 disabled:cursor-wait"
          >
            {isLoading === 'github' ? <Loader2 className="w-5 h-5 animate-spin" /> : (
