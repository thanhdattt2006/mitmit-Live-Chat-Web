    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md bg-[#141414] rounded-3xl shadow-2xl border border-neutral-800 flex flex-col overflow-hidden animate-slide-up text-white">
        <div className="px-6 py-5 border-b border-neutral-800 flex justify-between items-center bg-neutral-900/50 backdrop-blur-sm">
          <h2 className="text-lg font-bold">{t.EDIT_PROFILE}</h2>
        ...
        <div className="p-6">
          ...
          <div className="space-y-4">
            <div>
              <label className="text-xs text-gray-400 font-semibold uppercase tracking-wider mb-1 block">{t.DISPLAY_NAME}</label>
              <input 
                name="name"
                value={formData.name}
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="text-xs text-gray-400 font-semibold uppercase tracking-wider mb-1 block">{t.AGE}</label>
                <input 
                  name="age"
                  value={formData.age}
                  onChange={handleChange}
              ...
              <div>
                <label className="text-xs text-gray-400 font-semibold uppercase tracking-wider mb-1 block">{t.GENDER}</label>
                <select 
                  name="gender"
            ...
            <div>
              <label className="text-xs text-gray-400 font-semibold uppercase tracking-wider mb-1 block">{t.CITY}</label>
              <input 
                name="city"
                value={formData.city}
                onChange={handleChange}
